...
/**
 * User profile and registry schemas, key hashing, validation.
 * Spec: docs/Design Docs/User_roles_design.md
 */
App.UserData = (function () {
  ...
  return {
    ...
    USER_FILE_VERSION: USER_FILE_VERSION,
    uid: uid,
    generateKey: generateKey,
    hashKey: hashKey,
    hashKeySync: hashKeySync,
    verifyKey: verifyKey,
    createEmptyRegistry: createEmptyRegistry,
    migrateRegistry: migrateRegistry,
    migrateUserFile: migrateUserFile,
    formatFullName: formatFullName,
    splitLegacyName: splitLegacyName,
    createUserFile: createUserFile,
    createRegistryEntry: createRegistryEntry,
    migrateRegistryUserEntry: migrateRegistryUserEntry,
    validateSession: validateSession,
    serializeRegistry: serializeRegistry,
    serializeUserFile: serializeUserFile
  };
})();
