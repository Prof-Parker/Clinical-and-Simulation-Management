...
/**
 * Canonical semester snapshot hashing for audit exports
 * (spec: docs/AUDIT_TRACKING_IMPLEMENTATION.md §4.4).
 *
 * The hash covers scheduling-relevant data only; volatile fields
 * (meta.lastModified, _simCalendar caches) are stripped so that saving without
 * changes does not alter the hash.
 */
App.AuditSnapshot = (function () {
