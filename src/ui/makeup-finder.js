...
var pendingClinicalHint = null;
  ...
  function init() {
    ...
    document.getElementById('makeupSimSelect').addEventListener('change', function () { refresh(); });
    document.getElementById('makeupResults').addEventListener('click', function (e) {
      ...
      var applyResult = Scheduler.applyMakeupSlot(getData(), btn.dataset.student, slot, applyType, getAppliedByName());
