/**
 * Week-bounded date input helpers.
 */
...
var CALENDAR_ICON =
  ...
  function holidayRange(data) {
    ...
    var lastStart = CalendarEngine.parseDate(weeks[weeks.length - 1].startDate);
    var max = lastStart ? CalendarEngine.toISO(CalendarEngine.addDays(lastStart, 6)) : null;
