...
#features
- [ ] Set light or dark mode based on system/browser Settings
...
- [ ] Add post processing pass to force move students
...
## Phase 1 [ ]
1. Support multiple courses (in progess)[]
2. Clinical hour tracking [ ]
3. Clinical site library [X]
4. Clinical site tags/sub sites [X]
